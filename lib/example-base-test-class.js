...
var MyExampleBaseClass = function (data, steps) {
  // if steps === null, test is initialized like new Test({step});
  var compose = data;
  // in case test is initialized like new Test([data], function(data){return {steps}});
  if (steps && typeof steps === "function") {
    compose = _.spread(steps)(data)
  }
  
  // call super-constructor
  Base.call(this, compose);
};
